...
<html>
 ...
 <!--   <div class="text-center">
    <h1 class="display-5 fw-bold " style="color:#00008B;margin-top: 50px;">Chase Safety, Not Speed</h1>
  </div> -->
  
   <div class="text-center m-3">
    <p style="color:black;font-size:18px;margin-top: 50px;">Thank you for participating in <span style="font-weight:bold;">The Membership Development & Public Image Seminar</span> organized by <span style="font-weight:bold;">Rotary Clubs Of Kalyan Zone Bidar</span><span style="font-weight:bold;"></span></p>
  </div>
  ...
  <div class="container card shadow-lg p-3 mb-5 bg-body-tertiary rounded" style="border:2px solid blue;margin-top:50px;border-radius: 10px;">
    <h4 style="display: flex;align-items: center;justify-content: center;color: #00008B;">FILL THE BELOW DETAILS TO DOWNLOAD THE PARTICIPATION CERTIFICATE</h4><br/>
...
--%><g:hasErrors bean="${certificateInstance}">
    ...
    <g:submitButton name="create" class="btn btn-primary btn-center save" 
                    style="background-color: #00008B; font-size: 22px; font-weight: bold; border: 2px solid black;"   
                    value="${message(code: 'default.button.download.label', default: 'Download Certificate')}" />
</fieldset>
			</g:form>
		</div>
